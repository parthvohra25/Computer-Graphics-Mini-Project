...
void display()
{
    ...
    if (gameover == true)
    {
        drawTextRed("Game Over", 43, 57);
        drawTextRed("Press UP Arrow Key to play again", 33, 52);
        score = -1;
        glutSwapBuffers(); //swaps the buffers of the current window if double buffered
        drawTextRed("Published By :-", 43, 47);
        drawTextRed("Parth Vohra", 43, 42);
        drawTextRed("Bipasha Gupta", 43, 37);
    }
    ///end of live score
    glFlush();
